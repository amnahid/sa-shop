    ...
    <div className="p-6">
      ...
      <form className="bg-card border rounded-lg p-4 mb-6 flex flex-wrap gap-3 items-end">
        <div>
          ...
          <input type="date" name="fromDate" defaultValue={fromDate || today.toISOString().split("T")[0]} className="h-9 rounded-md border border-input bg-background px-3 text-sm" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">To Date</label>
          <input type="date" name="toDate" defaultValue={toDate || new Date().toISOString().split("T")[0]} className="h-9 rounded-md border border-input bg-background px-3 text-sm" />
        </div>
        <div>
