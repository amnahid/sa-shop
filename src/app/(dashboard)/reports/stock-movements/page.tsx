    ...
    <div className="p-6">
      ...
      <form className="bg-card border rounded-lg p-4 mb-6 flex flex-wrap gap-3 items-end">
        <div>
          ...
          <input type="date" name="fromDate" defaultValue={params.fromDate || ""} className="h-11 rounded-md border border-input bg-white bg-background px-3 text-sm" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">To Date</label>
          <input type="date" name="toDate" defaultValue={params.toDate || ""} className="h-11 rounded-md border border-input bg-white bg-background px-3 text-sm" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Branch</label>
          <select name="branchId" defaultValue={params.branchId || ""} className="h-11 rounded-md border border-input bg-white bg-background px-3 text-sm">
        ...
        <div>
          ...
          <select name="type" defaultValue={params.type || ""} className="h-11 rounded-md border border-input bg-white bg-background px-3 text-sm">
